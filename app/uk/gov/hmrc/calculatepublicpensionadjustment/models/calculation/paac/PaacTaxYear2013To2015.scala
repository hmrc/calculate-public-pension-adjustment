...
case class PaacTaxYear2013To2015(
  pensionInputAmount: Int,
  period: Period
) extends PaacTaxYear

object PaacTaxYear2013To2015 {

  implicit lazy val reads: Reads[PaacTaxYear2013To2015] = {
    ...
    (__ \ "period")
      ...
      )(PaacTaxYear2013To2015.apply _)
    }
  }

  implicit lazy val writes: Writes[PaacTaxYear2013To2015] = {
