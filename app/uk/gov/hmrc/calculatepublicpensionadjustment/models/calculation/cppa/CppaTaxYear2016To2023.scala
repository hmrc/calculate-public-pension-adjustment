...
sealed trait CppaTaxYear2016To2023 extends CppaTaxYear

object CppaTaxYear2016To2023 {
  ...
  implicit lazy val writes: Writes[CppaTaxYear2016To2023] = {
    ...
    lazy val initialWrites: Writes[CppaTaxYear2016To2023.InitialFlexiblyAccessedTaxYear] = (
    ...
    lazy val postWrites: Writes[CppaTaxYear2016To2023.PostFlexiblyAccessedTaxYear] = (
      (__ \ "definedBenefitInputAmount").write[Int] and
    ...
    Writes {
      case year: CppaTaxYear2016To2023.NormalTaxYear =>
        Json.toJson(year)(normalWrites)

      case year: CppaTaxYear2016To2023.InitialFlexiblyAccessedTaxYear =>
        Json.toJson(year)(initialWrites)

      case year: CppaTaxYear2016To2023.PostFlexiblyAccessedTaxYear =>
