...
case class CalculationResponse(outDates: List[OutOfDatesTaxYearsCalculation], inDates: List[InDatesTaxYearsCalculation])
...
object CalculationResponse {
  ...
  implicit lazy val reads: Reads[CalculationResponse] = {
    ...
    ((__ \ "outDates").read[List[OutOfDatesTaxYearsCalculation]] and
      (__ \ "inDates").read[List[InDatesTaxYearsCalculation]])(CalculationResponse(_, _))
  }
