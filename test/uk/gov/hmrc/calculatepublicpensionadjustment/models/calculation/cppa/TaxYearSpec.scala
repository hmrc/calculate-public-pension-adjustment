...
import uk.gov.hmrc.calculatepublicpensionadjustment.models.{IncomeSubJourney, Period, TaxYear, TaxYear2013To2015, TaxYear2016To2023}
import uk.gov.hmrc.calculatepublicpensionadjustment.models.TaxYearScheme

class TaxYearSpec extends AnyFreeSpec with Matchers with ScalaCheckPropertyChecks {

  "TaxYear reads" - {
    "correctly deserialize TaxYear2013To2015" in {
      val json = Json.obj("period" -> Period._2013, "pIAPreRemedy" -> 1)
      json.validate[TaxYear] `mustEqual` JsSuccess(
        TaxYear2013To2015(1, Period._2013)
      )
    }
    ...
    "correctly deserialize TaxYear2016to2023" in {
      val json = Json.obj(
        ...
        "taxYearSchemes"     -> List(TaxYearScheme("name", "ref", 1, 1)),
        "totalIncome"        -> 1,
      ...
      json.validate[TaxYear] `mustEqual` JsSuccess(
        TaxYear2016To2023.NormalTaxYear(
          1,
          List(TaxYearScheme("name", "ref", 1, 1)),
          1,
          1,
          Period._2017,
          IncomeSubJourney(
  ...
  "TaxYear writes" - {
    "must serialise TaxYear2013to2015" in {

      val json = Json.obj("pensionInputAmount" -> 1, "period" -> Period._2013)
      Json.toJson[TaxYear](TaxYear2013To2015(1, Period._2013)) `mustEqual` json
    }
